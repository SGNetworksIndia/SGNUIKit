...
Or if you have a new feature which can be added in the `Ceramic Core`, just email to [rfc@sgnuikit.repository.sgnetworks.eu.org](mailto:rfc@sgnuikit.repository.sgnetworks.eu.org) with your proposal.
